        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
            <form onSubmit={onSubmit}>
                    ...
                    <p className="font-bold text-2xl text-center">당신의 아이디어를 공유하고, 다른 사람들과 함께하세요.</p>
                        <Input className="px-6 py-4" placeholder="이름" value={name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setName(e.target.value)} />
                        ...
                        <Input className="px-6 py-4" placeholder="비밀번호 확인" type="password" value={confirm} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setComfirm(e.target.value)} />
                        <Button type="submit" className="bg-[#a54cff] py-4 rounded-2xl border-none">dd</Button> 
                    </div>
            </form>
        </div>
